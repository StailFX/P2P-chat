...
Учебный SPA-проект — P2P чат и обмен файлами без сервера. Сигналинг
поначалу — заглушка через `BroadcastChannel` (вкладки браузера в пределах
одного origin), с расчётом на дальнейшую замену на настоящий сервер.
...
Тёмная тема, аватары — эмодзи (зверушки + ракета и алмаз). Дизайн-токены
живут в `src/styles/theme.js`.
